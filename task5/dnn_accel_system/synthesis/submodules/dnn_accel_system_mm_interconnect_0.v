...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire    [6:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> DMA_copy_0_avalon_master_agent:rp_channel
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> VGA_avalon_0_avalon_slave_0_agent:cp_channel
	...
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> hex_s1_agent:cp_channel
	...
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> DMA_copy_0_slave_agent:cp_channel
	...
	wire   [89:0] sdram_controller_s1_agent_rp_data;                                                  // sdram_controller_s1_agent:rp_data -> router_003:sink_data
	...
	wire          vga_avalon_0_avalon_slave_0_agent_rp_valid;                                         // VGA_avalon_0_avalon_slave_0_agent:rp_valid -> router_005:sink_valid
	wire  [107:0] vga_avalon_0_avalon_slave_0_agent_rp_data;                                          // VGA_avalon_0_avalon_slave_0_agent:rp_data -> router_005:sink_data
	wire          vga_avalon_0_avalon_slave_0_agent_rp_ready;                                         // router_005:sink_ready -> VGA_avalon_0_avalon_slave_0_agent:rp_ready
	wire          vga_avalon_0_avalon_slave_0_agent_rp_startofpacket;                                 // VGA_avalon_0_avalon_slave_0_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          vga_avalon_0_avalon_slave_0_agent_rp_endofpacket;                                   // VGA_avalon_0_avalon_slave_0_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [107:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_006:sink_data
	...
	wire          hex_s1_agent_rp_valid;                                                              // hex_s1_agent:rp_valid -> router_008:sink_valid
	wire  [107:0] hex_s1_agent_rp_data;                                                               // hex_s1_agent:rp_data -> router_008:sink_data
	wire          hex_s1_agent_rp_ready;                                                              // router_008:sink_ready -> hex_s1_agent:rp_ready
	wire          hex_s1_agent_rp_startofpacket;                                                      // hex_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          hex_s1_agent_rp_endofpacket;                                                        // hex_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          dma_copy_0_slave_agent_rp_valid;                                                    // DMA_copy_0_slave_agent:rp_valid -> router_009:sink_valid
	wire  [107:0] dma_copy_0_slave_agent_rp_data;                                                     // DMA_copy_0_slave_agent:rp_data -> router_009:sink_data
	wire          dma_copy_0_slave_agent_rp_ready;                                                    // router_009:sink_ready -> DMA_copy_0_slave_agent:rp_ready
	wire          dma_copy_0_slave_agent_rp_startofpacket;                                            // DMA_copy_0_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          dma_copy_0_slave_agent_rp_endofpacket;                                              // DMA_copy_0_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [107:0] cmd_demux_002_src0_data;                                                            // cmd_demux_002:src0_data -> cmd_mux_003:sink1_data
	wire          cmd_demux_002_src0_ready;                                                           // cmd_mux_003:sink1_ready -> cmd_demux_002:src0_ready
	wire    [6:0] cmd_demux_002_src0_channel;                                                         // cmd_demux_002:src0_channel -> cmd_mux_003:sink1_channel
	...
	wire  [107:0] cmd_demux_002_src1_data;                                                            // cmd_demux_002:src1_data -> cmd_mux_004:sink1_data
	...
	wire  [107:0] cmd_demux_002_src2_data;                                                            // cmd_demux_002:src2_data -> cmd_mux_006:sink1_data
	...
	wire  [107:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> rsp_mux_002:sink0_data
	wire          rsp_demux_003_src1_ready;                                                           // rsp_mux_002:sink0_ready -> rsp_demux_003:src1_ready
	wire    [6:0] rsp_demux_003_src1_channel;                                                         // rsp_demux_003:src1_channel -> rsp_mux_002:sink0_channel
	...
	wire  [107:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_002:sink1_data
	...
	wire  [107:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_002:sink2_data
	...
	wire   [89:0] router_003_src_data;                                                                // router_003:src_data -> sdram_controller_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                               // sdram_controller_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [6:0] router_003_src_channel;                                                             // router_003:src_channel -> sdram_controller_s1_rsp_width_adapter:in_channel
	...
	wire    [6:0] sdram_controller_s1_rsp_width_adapter_src_channel;                                  // sdram_controller_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [6:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> sdram_controller_s1_cmd_width_adapter:in_channel
	...
	wire    [6:0] sdram_controller_s1_cmd_width_adapter_src_channel;                                  // sdram_controller_s1_cmd_width_adapter:out_channel -> sdram_controller_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] cmd_demux_001_src0_channel;                                                         // cmd_demux_001:src0_channel -> crosser_001:in_channel
	...
	wire    [6:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux:sink1_channel
	...
	wire  [107:0] rsp_demux_src1_data;                                                                // rsp_demux:src1_data -> crosser_003:in_data
	wire          rsp_demux_src1_ready;                                                               // crosser_003:in_ready -> rsp_demux:src1_ready
	wire    [6:0] rsp_demux_src1_channel;                                                             // rsp_demux:src1_channel -> crosser_003:in_channel
	...
	wire  [107:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink0_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_001:sink0_ready -> crosser_003:out_ready
	wire    [6:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink0_channel
	...
	dnn_accel_system_mm_interconnect_0_router_004 router_005 (
	...
	dnn_accel_system_mm_interconnect_0_router_004 router_008 (
	...
	dnn_accel_system_mm_interconnect_0_router_006 router_009 (
	...
	dnn_accel_system_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (pll_0_outclk0_clk),                            //       clk.clk
		.reset               (DMA_copy_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (pll_0_outclk0_clk),                            //       clk.clk
		.reset              (DMA_copy_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
