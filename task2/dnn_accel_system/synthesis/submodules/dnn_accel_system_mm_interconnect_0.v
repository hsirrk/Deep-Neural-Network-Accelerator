...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> hex_s1_agent:cp_valid
	wire  [103:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> hex_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // hex_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> hex_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> hex_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> hex_s1_agent:cp_endofpacket
	...
	wire          hex_s1_agent_rp_valid;                                                              // hex_s1_agent:rp_valid -> router_005:sink_valid
	wire  [103:0] hex_s1_agent_rp_data;                                                               // hex_s1_agent:rp_data -> router_005:sink_data
	wire          hex_s1_agent_rp_ready;                                                              // router_005:sink_ready -> hex_s1_agent:rp_ready
	wire          hex_s1_agent_rp_startofpacket;                                                      // hex_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          hex_s1_agent_rp_endofpacket;                                                        // hex_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire   [85:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire    [4:0] new_sdram_controller_0_s1_burst_adapter_source0_channel;                            // new_sdram_controller_0_s1_burst_adapter:source0_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire          router_006_src_valid;                                                               // router_006:src_valid -> new_sdram_controller_0_s1_rsp_width_adapter:in_valid
	wire   [85:0] router_006_src_data;                                                                // router_006:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                               // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [4:0] router_006_src_channel;                                                             // router_006:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                                       // router_006:src_startofpacket -> new_sdram_controller_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                         // router_006:src_endofpacket -> new_sdram_controller_0_s1_rsp_width_adapter:in_endofpacket
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_valid;                              // new_sdram_controller_0_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [103:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                               // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_ready;                              // rsp_demux_004:sink_ready -> new_sdram_controller_0_s1_rsp_width_adapter:out_ready
	wire    [4:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_startofpacket;                      // new_sdram_controller_0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_endofpacket;                        // new_sdram_controller_0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> new_sdram_controller_0_s1_cmd_width_adapter:in_valid
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                              // new_sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> new_sdram_controller_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> new_sdram_controller_0_s1_cmd_width_adapter:in_endofpacket
	...
	wire    [4:0] new_sdram_controller_0_s1_cmd_width_adapter_src_channel;                            // new_sdram_controller_0_s1_cmd_width_adapter:out_channel -> new_sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	wire          hex_s1_agent_rdata_fifo_src_valid;                                                  // hex_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] hex_s1_agent_rdata_fifo_src_data;                                                   // hex_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          hex_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_003:in_0_ready -> hex_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> hex_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> hex_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                  // hex_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> hex_s1_agent:rdata_fifo_sink_error
	...
	dnn_accel_system_mm_interconnect_0_router_003 router_004 (
	...
	dnn_accel_system_mm_interconnect_0_router_002 router_005 (
	...
	dnn_accel_system_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
