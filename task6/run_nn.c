...
#define DONE_TASK6 1  // create dot product accelerator
...
{
    // computes using hardware for both task6 or task7
    // task6 uses DRAM
    // task7 uses on-chip SRAM (bank0, bank1)
